...
export class CommentableServiceMixin {
	...
	editComment(item: ICommentable, commentId: string, updatedComment: string): Observable<ICommentable> {
		return this.service.http
			.patch(`${this.service.serviceConfig.rootApiUrl}/${this.service.serviceConfig.urlSuffix}${CONST.ep.COMMENTS}/${item._id}`, {
